...
@Data
@NoArgsConstructor
public class DiscussBoardImage {
	@Id
	...
	@Builder
	public DiscussBoardImage(String imagePath, String originalFileName, String savedFileName,
		Long fileSize, String contentType, Integer imageOrder,
		DiscussBoard discussBoard, LocalDateTime uploadedAt) {
